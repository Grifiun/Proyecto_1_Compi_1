...
DATOS_RECOPILADOS = \" [\0-\40]* DATOS_RECOPILADOS [\0-\40]* \"
REGISTRO = \" [\0-\40]* REGISTRO "-" [[:digit:]]+ [\0-\40]* \"
...
<YYINITIAL>{
    ...
    {DBFORMULARIOS} { return retornarSimbolo(DBFORMULARIOS, "DBFORMULARIOS", yytext(), yyline + 1, yycolumn + 1); }
    {DBUSUARIOS} { return retornarSimbolo(DBUSUARIOS, "DBUSUARIOS", yytext(), yyline + 1, yycolumn + 1); }
    ...
    {DATOS_RECOPILADOS} { return retornarSimbolo(DATOS_RECOPILADOS, "DATOS_RECOPILADOS", yytext(), yyline + 1, yycolumn + 1); }
    {REGISTRO} { return retornarSimbolo(REGISTRO, "REGISTRO", yytext(), yyline + 1, yycolumn + 1); }
